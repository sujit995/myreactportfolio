...
// projects
import L_Memories from "../../assets/img/projects/memories.webp";
        ...
        <Events>
          ...
          >
            <div className="d-flex justify-content-between flex-column mt-1">
                ...
                <Accordion>
                  <Card>
                    ...
                    <Accordion.Collapse eventKey="0" className="text-left">
                      <Card.Body>
                        <strong>Description:</strong> it is a simple social media app that allows users to post interesting events that happened in their lives.
                        <hr />
                        <strong>Features:</strong>
                        <ul className="list-styles pt-1">
                          <li>An User can Create,Update and Delete the Post</li>
                          <li>Like the Post</li>
                        </ul>
                        <hr />
              ...
              <div className="d-flex justify-content-between flex-nowrap text-center">
                <UrlButton
                  href="https://memories-store-app.netlify.app"
                  target="_blank"
                >
                  SEE LIVE
                </UrlButton>
          ...
          >
            <div className="d-flex justify-content-between flex-column mt-1">
              ...
              <div className="d-flex justify-content-between flex-nowrap text-center">
                <UrlButton
                  href="https://smartbrain-face-detectapp.herokuapp.com/"
                  target="_blank"
                >
                  SEE LIVE
                </UrlButton>
          ...
          >
            <div className="d-flex justify-content-between flex-column mt-1">
              ...
              <div className="d-flex justify-content-between flex-nowrap text-center">
                <UrlButton
                  href=" https://sujit995.github.io/robofriends/"
                  target="_blank"
                >
                  SEE LIVE
                </UrlButton>
